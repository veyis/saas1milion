...
export async function getUserSubscriptionTier(userId: string) {
  ...
  if (subscription == null) {
    console.warn(`No subscription found for user ID: ${userId}. Assigning default "Free" tier.`);
    return subscriptionTiers["Free"];
  }

  if (!subscription.tier || !(subscription.tier in subscriptionTiers)) {
    console.warn(`Invalid subscription tier for user ID: ${userId}. Assigning default "Free" tier.`);
    return subscriptionTiers["Free"];
  }

  return subscriptionTiers[subscription.tier as keyof typeof subscriptionTiers];
}
